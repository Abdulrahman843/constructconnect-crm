  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center text-center p-8 bg-blue-100 overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* Title and Subtitle */}
        <h1 className="text-3xl md:text-5xl font-extrabold text-blue-700 mb-6 drop-shadow-md">
          Welcome to <span className="text-blue-600">ConstructConnect CRM</span>
        </h1>
        <p className="text-base md:text-lg text-gray-700 mb-10 max-w-2xl leading-relaxed px-4">
        ...
        {/* Feature Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-12 w-full max-w-6xl">
        ...
        <a
          href="/dashboard"
          className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-full shadow-md transition-all duration-300 hover:scale-105 mt-8"
        >
          🚀 Get Started
        </a>

        {/* Stats Counters */}
        <section className="relative z-10 mt-20 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-center">
          <div>
        ...
        <section className="relative z-10 mt-20 py-10">
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-8">
            <Image src="/images/logo1.svg" alt="Partner 1" width={100} height={50} className="h-12 object-contain mx-auto" />
            <Image src="/images/logo2.svg" alt="Partner 2" width={100} height={50} className="h-12 object-contain mx-auto" />
            <Image src="/images/logo3.svg" alt="Partner 3" width={100} height={50} className="h-12 object-contain mx-auto" />
            <Image src="/images/logo4.svg" alt="Partner 4" width={100} height={50} className="h-12 object-contain mx-auto" />
          </div>
        </section>
